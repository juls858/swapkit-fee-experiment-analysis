...
/*
  ...
  This model:
  - Filters swaps to experiment window
  - Calculates effective fee in basis points
  - Adds date dimensions and classifications
  - Excludes zero-volume swaps
*/
...
WITH base_swaps AS (
    ...
    FROM {{ source('thorchain_defi', 'FACT_SWAPS') }}
    WHERE
